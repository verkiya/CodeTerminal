...
/* Align all command names in a fixed-width column so their descriptions start at the same horizontal position for a clean tabular look.
      ...
      {filtered.map((cmd, i) => {
        ...
        return (
          <box
            ...
            height={1}
            overflow="hidden"
            backgroundColor={isSelected ? "#C4B5FD" : undefined}
